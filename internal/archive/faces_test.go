...
`, assetID, "92D69D06-27F0-4831-AEC7-C6F640F075BA/L0/001", sourceID)
	...
	assertCount(t, archiveDB.DB(), `select count(*) from observation_fts where asset_id = ?`, 4, assetID)
}
...
func createTestPhotosDB(t *testing.T, path string) {
	...
	execTestSQL(t, db, `insert into ZPERSON(Z_PK, ZDISPLAYNAME, ZFULLNAME, ZPERSONUUID) values (1, 'Maga', 'Maga', '08EA22FD-06A7-4145-829F-D724B9DD1BB6')`)
}
...
func createTestPSIDB(t *testing.T, path string) {
	...
	execTestSQL(t, db, `insert into groups(rowid, category, owning_groupid, content_string, normalized_string, lookup_identifier, score) values (11, 1300, null, 'Maga'||char(0), 'maga'||char(0), '08EA22FD-06A7-4145-829F-D724B9DD1BB6'||char(0), 0.8)`)
