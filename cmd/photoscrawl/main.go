...
func usage() error {
	return output.UsageError{Err: errors.New("usage: photoscrawl <metadata|init|status|crawl|import-apple|classify|search|open|neighbors|evidence|place-context|place-card|place-backfill|eval-card>")}
}
